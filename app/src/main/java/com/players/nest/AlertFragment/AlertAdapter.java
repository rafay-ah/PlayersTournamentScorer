...
public class AlertAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<MatchDetail> mList;
    DatabaseReference userReference, matchReference;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser();

    public AlertAdapter(Context context, ArrayList<MatchDetail> mList) {
    ...
    public int getItemViewType(int position) {
        String matchStatus = mList.get(position).getMatchStatus();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == MATCH_CONNECTING) {
            View view = inflater.inflate(R.layout.alert_match_connecting, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == MATCH_CONNECTING) {
        ...
        userReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (type == MATCH_FINISHED) {
                    if (mList.get(position).getMatchWinner().equals(firebaseUser.getUid()))
    ...
    public class mViewHolderClass extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView console, message, gameName, disabledTxt, time;
        ...
        public mViewHolderClass(@NonNull View itemView) {
            ...
            profilePic = itemView.findViewById(R.id.imageView40);
            console = itemView.findViewById(R.id.textView106);
            ...
            matchReference = FirebaseDatabase.getInstance().getReference(context.getString(R.string.DB_MATCHES));
        ...
        public void setData(int position) {
            ...
            if (mList.get(position).getMatchStatus().equals(Constants.MATCH_CONNECTING)) {
                console.setText(mList.get(position).getConsole());
...
//                    , System.currentTimeMillis(), DateUtils.MINUTE_IN_MILLIS));
            ...
            } else if (mList.get(position).getMatchStatus().equals(Constants.MATCH_WAITING)) {
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.button12) {
                ...
                matchReference.child(mList.get(getAdapterPosition()).getMatch_ID())
    ...
    private class matchFinishedViewHolderClass extends RecyclerView.ViewHolder {

        TextView msg, time;
        ImageView opponentImage;

        public matchFinishedViewHolderClass(@NonNull View itemView) {
            super(itemView);
        ...
        public void setData(int position) {
            time.setText(DateUtils.getRelativeTimeSpanString(Long.parseLong(mList.get(position).getMatchFinishedTime())
                    , System.currentTimeMillis(), DateUtils.MINUTE_IN_MILLIS));
