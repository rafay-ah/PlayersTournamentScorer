...
public class TrimVideoUtils {
    ...
    public static void startTrim(@NonNull File src, @NonNull String dst, long startMs, long endMs,
                                 @NonNull OnTrimVideoListener callback, boolean isAndroidQ,
                                 LoadingDialog loadingDialog) throws IOException {
...
//        Log.d(TAG, "Generated file path " + filePath);
        genVideoUsingMp4Parser(src, file, startMs, endMs, callback, isAndroidQ, loadingDialog);
    }

    private static void genVideoUsingMp4Parser(@NonNull File src, @NonNull File dst, long startMs,
                                               long endMs, @NonNull OnTrimVideoListener callback,
                                               boolean isAndroidQ, LoadingDialog loadingDialog)
            throws IOException {
        ...
        if (isAndroidQ) {
            if (FileUtils.deleteCopiedFile(src))
                Log.d(TAG, "genVideoUsingMp4Parser: Deleted File");
            else
                Log.d(TAG, "genVideoUsingMp4Parser: NOT Deleted File");
        }
